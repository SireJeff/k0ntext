...
describe('createDirectoryStructure', () => {
  ...
  test('creates .ai-context directory', async () => {
    await createDirectoryStructure(testDir, {});
    expect(fs.existsSync(path.join(testDir, '.ai-context'))).toBe(true);
  });
  ...
  test('creates core directories', async () => {
    ...
    for (const dir of expectedDirs) {
      expect(fs.existsSync(path.join(testDir, '.ai-context', dir))).toBe(true);
    }
  });
  ...
  test('creates nested directories', async () => {
    ...
    expect(fs.existsSync(path.join(testDir, '.ai-context', 'plans', 'active'))).toBe(true);
    expect(fs.existsSync(path.join(testDir, '.ai-context', 'plans', 'completed'))).toBe(true);
    expect(fs.existsSync(path.join(testDir, '.ai-context', 'research', 'active'))).toBe(true);
  });
