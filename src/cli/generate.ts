...
function generateContentInline(tool: string, contextItems: SimpleContextItem[], useMapFormat: boolean): string {
 ...
 */
function generateClaudeMapContext(projectName: string, description: string, items: SimpleContextItem[]): string {
 ...
 */
function generateCopilotMapContext(projectName: string, description: string, items: SimpleContextItem[]): string {
 ...
 */
function generateClineMapContext(projectName: string, description: string, _items: SimpleContextItem[]): string {
 ...
 */
function generateCursorMapContext(projectName: string, description: string, _items: SimpleContextItem[]): string {
  return `# ${projectName}
 ...
 */
function generateGeminiMapContext(projectName: string, description: string, _items: SimpleContextItem[]): string {
...
function generateClaudeContext(projectName: string, description: string, items: SimpleContextItem[]): string {
  return `# ${projectName}
...
function generateCopilotContext(projectName: string, description: string, items: SimpleContextItem[]): string {
  return `# ${projectName}
...
function generateClineContext(projectName: string, description: string, items: SimpleContextItem[]): string {
...
function generateAiderConfig(_items: SimpleContextItem[]): string {
